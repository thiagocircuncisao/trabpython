# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-04-18 23:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='ContaBancaria',
            fields=[
                ('contaBancariaId', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Pessoa',
            fields=[
                ('pessoaId', models.IntegerField(primary_key=True, serialize=False)),
                ('classificacao', models.CharField(max_length=18)),
                ...
                ('municipioID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='financ.Muncipio')),
            ],
        ),
        migrations.CreateModel(
            name='PlanoContas',
            fields=[
                ('planoContasId', models.IntegerField(primary_key=True, serialize=False)),
                ('classificacao', models.CharField(max_length=18)),
                ...
                ('contaCancariaId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='financ.ContaBancaria')),
            ],
        ),
        migrations.CreateModel(
            name='Uf',
            fields=[
                ('ufId', models.IntegerField(primary_key=True, serialize=False)),
                ('descricao', models.CharField(max_length=50)),
            ],
        ),
        migrations.AddField(
            model_name='pessoa',
            name='ufId',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='financ.Uf'),
        ),
        migrations.AddField(
            model_name='muncipio',
            name='ufId',
